...
\begin{figure}[htbp] %浮動式圖形
  \begin{center} %中央寄せ
  \includegraphics[width=85mm]{images/new_verification_time.png} %[サイズ]{ファイル名.png}
  \caption{Verifiable Presentation Response Time for Each Authentication flow} %キャプション
  \label{fig:new_verification_time} %ラベル名label
  \end{center}
\end{figure}
...
\begin{figure}[htbp] %浮動式圖形
  \begin{center} %中央寄せ
  \includegraphics[width=85mm]{images/exper_fig/vc_gas_consumption.png} %[サイズ]{ファイル名.png}
  \caption{The Gas Consumption of Each VC Registry Contract's API} %キャプション
  \label{fig:vc_gas_consumption} %ラベル名label
  \end{center}
\end{figure}
